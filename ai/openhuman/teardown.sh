#!/bin/bash
# Tears down the OpenHuman Core stack completely.
...
# The openhuman-workspace volume contains all memory trees, cached integrations,
# and SQLite databases. After teardown, re-running start.sh creates a fresh installation.
set -e
...
echo ""
echo "Volumes  (ALL DATA WILL BE LOST — memory trees, integrations, and databases):"
